...
const Profiel5Detail = () => {

    const breadcrumbItems = [
        { text: "Home", href: '/' },
        { text: "Profiel 5 Detail" },
    ];
            ...
            <Container>
                ...
                <Grid2 container spacing={2}>
                    ...
                    <Grid2 item size={{ xs: 12, md: 6 }}>
                        <Box component='img' src='/profile5.jpg' className='h-[75vh]' />
                    </Grid2>

                    <Grid2 item size={{ xs: 12, md: 6 }}>
                        <Box sx={{ pt: 4, display: 'flex', flexDirection: 'column', gap: 2 }}>
                            <Typography variant='h5' fontWeight={600}>Profiel 5</Typography>
