        ...
        <>
            <Container>
                ...
                <Box>
                    ...
                    {
                            totalPrice && <Grid2 item size={10} justifyContent='end'>
                                <Box sx={{ display: 'flex', justifyContent: 'center' , border: '2px solid #B91C1C', padding: 2, borderRadius: '4px'}}>
                        ...
                        <Grid2 item size={10}>
                            ...
                            <Accordion sx={{ border: '1px solid #B91C1C', boxShadow: 'none' }}>
                                <AccordionSummary
                                    ...
                                    id="panel1-header"
                                >
                                    <Typography flex={1} variant='body1'>Plexi Size</Typography>
                                    {
                                        selections.plexi_size &&
                                        <Typography flex={1} variant='body1'>{selections.plexi_size}mm</Typography>
                                    }
                                </AccordionSummary>
                                ...
                                <AccordionDetails>
                                    <Grid2 container spacing={2} alignItems="center">
                                        {[3, 5, 10, 19].map((size) => (
                                            <Grid2 item size={{ xs: 12, md: 4 }} key={size}>
                                                <Box
                                                    sx={{
                                                        paddingY: 2,
                                                        border: selections.plexi_size === size ? '1px solid #B91C1C' : '1px solid #cbd5e1',
                                                        borderRadius: '4px',
                                                        display: 'flex',
                                                        justifyContent: 'center',
                                                        cursor: 'pointer',
                                                    }}
                                                    onClick={() => handleSelection('plexi_size', size)}
                                                >
                                                    <Typography variant='body1'>{size}mm</Typography>
                                                </Box>
                                            </Grid2>
                                        ))}
